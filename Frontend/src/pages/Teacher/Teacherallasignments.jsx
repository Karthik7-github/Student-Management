          ...
          <div className="activebox123">
            {activeAssignments.length > 0 ? (
              activeAssignments.map((item, key) => {
                return (
                  <div className="notboxwel" style={{ marginTop: "10px",backgroundColor:item.Color }} key={key}>
                    <div>
                      <span></span>
                      <span style={{ paddingLeft: "100px"}}>📅 {item.Time}</span>
                    </div>
                    <h1>{item.Title}</h1>
...
export default Teacherallanounces;
